...
<script type="application/javascript">
    $(function () {
        ...
        $("#snapshot_table").DataTable({
            ajax: '<?php echo \yii\helpers\Url::to('/examine/video?api=true')?>',
            bAutoWidth: false,
            ordering: true,
            oLanguage: {
                oPaginate: {
            ...
            aoColumnDefs: [
                ...
                },
                {
                    ...
                    "render" : function(data, type, row) {
                        var html = '';
                        html+= "<div class='video_url'><a href='"+row.video_url+"' target='_blank'>"+row.video_url+"</a></div>";
                        return html;
                    }
                },
            ],
    ...
    function checkInfo(checkResult) {
        ...
        $.ajax({
            type:'POST',
            dataType: 'json',
            url : '<?php echo yii\helpers\Url::to('/examine/check-video')?>',
            data : formdata,
